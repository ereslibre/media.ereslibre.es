...
public:
    ...
    void paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget = 0)
    {
        ...
        g.setColorAt(0, fixed ? Qt::blue : Qt::yellow);
...
protected:
    ...
    void mouseReleaseEvent(QGraphicsSceneMouseEvent *event)
    {
        ...
        //force->x = (event->scenePos().x() - lastPos.x()) * 0.5;
        //force->y = (event->scenePos().y() - lastPos.y()) * 0.5;
...
protected:
    void timerEvent(QTimerEvent *event)
    {
        ...
        {
            Vector2D vel(b->force->x - a->force->x, b->force->y - a->force->y);
            Vector2D d(b->position->x - a->position->x, b->position->y - a->position->y);
            Vector2D nd = d.normalize();
...
int main(int argc, char **argv)
{
    ...
    Mass *m1 = new Mass(40, 100);
    Mass *m2 = new Mass(0, 100, true);
    Mass *m3 = new Mass(120, 100, true);
    Mass *m4 = new Mass(80, 100);
    //Mass *m2 = new Mass(10, 100);
    //Mass *m3 = new Mass(90, 100);
    graphicsScene->addItem(m1);
    graphicsScene->addItem(m2);
    graphicsScene->addItem(m3);
    graphicsScene->addItem(m4);
    graphicsScene->addItem(new Spring(m2, m1, 100));
    graphicsScene->addItem(new Spring(m1, m4, 20));
    graphicsScene->addItem(new Spring(m4, m3, 100));
