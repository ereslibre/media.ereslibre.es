...
//! [1]
    ...
    sourceView->setSelectionMode(QTreeView::ExtendedSelection);
...
//! [2]
    ...
    sourceGroupBox->setVisible(false);
//! [2]
...
//! [5]
    ...
    proxyView->setSelectionMode(QTreeView::ExtendedSelection); // BUG
    proxyView->setRootIsDecorated(false);
    proxyView->setAlternatingRowColors(true);
    proxyView->setModel(proxyModel);
    proxyView->setSortingEnabled(true);
    connect(proxyView->selectionModel(), SIGNAL(selectionChanged(QItemSelection,QItemSelection)),
...
void Window::setSourceModel(QAbstractItemModel *model)
{
    ...
    proxyView->setColumnHidden(1, true); // BUG
}
//! [7]
...
{
    QItemSelectionModel *selectionModel = static_cast<QItemSelectionModel*>(sender());
    qDebug() << "selection is " << selectionModel->selection();
}
